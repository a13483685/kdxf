        ...
        public void onResult(final RecognizerResult result, boolean isLast) {
        	if (null != result) {
        		...
        		if("cloud".equalsIgnoreCase(mEngineType)){
        			...
        			Log.e("demo",result.getResultString());
					Gson gson = new Gson();
					Data data = gson.fromJson(result.getResultString(),Data.class);
					String  str = data.getWs().get(0).getCw().get(0).getW();
					Log.i("the answer is :",str);
					if(str.equals("打开河长制")){
						startActivity(new Intent(AsrDemo.this, SecondActivity.class));
					}
				}else {
