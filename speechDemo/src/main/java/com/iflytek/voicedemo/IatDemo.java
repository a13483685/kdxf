...
import com.iflytek.activities.SecondActivity;
...
public class IatDemo extends Activity implements OnClickListener {
	...
	public void sendXmlTest(String msg) throws Exception{
//通过类装载器装载XML资源
		String path="http://222.187.219.82:9090/zhongyangz/api/PictureReceiving";
...
//		conn.setRequestProperty("Content-Length", String.valueOf(bytes.length));  //实体内容的长度
//		String str = new String(bytes);
		OutputStream out = conn.getOutputStream();
		out.write(bytes);  //通过输出流把数据写到服务器
		out.flush();
		out.close();
	...
	private void printResult(RecognizerResult results) {
		...
		if (resultBuffer.toString().equals("打开"))
		{
